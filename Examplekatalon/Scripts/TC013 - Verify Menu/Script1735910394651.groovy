...
WebUI.mouseOver(findTestObject('Object Repository/Menu_Page/mnu_Enabled'))
WebUI.click(findTestObject('Object Repository/Menu_Page/mnu_Enabled'))

'Hover over and click "JQuery UI menu" menu item'
WebUI.mouseOver(findTestObject('Object Repository/Menu_Page/mnu_JQueryUI'))
WebUI.click(findTestObject('Object Repository/Menu_Page/mnu_JQueryUI'))

'verify JQuery UI header title is displayed and back to JQueryUI - Menu URL'
WebUI.verifyTextPresent("JQuery UI", false)
WebUI.click(findTestObject('Object Repository/Menu_Page/lnk_Menu'))
...
WebUI.mouseOver(findTestObject('Object Repository/Menu_Page/mnu_Downloads'))
WebUI.click(findTestObject('Object Repository/Menu_Page/mnu_Downloads'))

'Click "CSV" menu item and verify download'
'Hover over and click "Enabled" menu item'
WebUI.mouseOver(findTestObject('Object Repository/Menu_Page/mnu_CSV'))
WebUI.click(findTestObject('Object Repository/Menu_Page/mnu_CSV'))
