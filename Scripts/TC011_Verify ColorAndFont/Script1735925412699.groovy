...
WebUI.click(findTestObject('Object Repository/Page_ChallengingDOM/lnk_ChallengingDOM'))
// Bước 1: Kiểm tra tiêu đề
WebUI.verifyEqual(WebUI.getText(findTestObject('Object Repository/Page_ChallengingDOM/hdr_ChallengingDOM')), "Challenging DOM")
// Bước 2: Kiểm tra font size của nút Button1
String fontSize = WebUI.getCSSValue(findTestObject('Object Repository/Page_ChallengingDOM/btn_Button1'), 'font-size')
WebUI.verifyEqual(fontSize, "16px")
// Bước 3: Kiểm tra background-color của nút Button2
String backgroundColor = WebUI.getCSSValue(findTestObject('Object Repository/Page_ChallengingDOM/btn_Button2'), 'background-color')
...
String borderColor = WebUI.getCSSValue(findTestObject('Object Repository/Page_ChallengingDOM/btn_Button3'), 'border-color')
// Chuyển đổi từ rgba sang hex
