...
String fontSize = WebUI.getCSSValue(findTestObject('Object Repository/011 - Verify Color and Font/btn_Button1'), 'font-size')
...
def actualColor = WebUI.getCSSValue(findTestObject('Object Repository/011 - Verify Color and Font/btn_Button2'), 'background-color')
...
def actualBorder = WebUI.getCSSValue(findTestObject('Object Repository/011 - Verify Color and Font/btn_Button3'), 'border-color')
