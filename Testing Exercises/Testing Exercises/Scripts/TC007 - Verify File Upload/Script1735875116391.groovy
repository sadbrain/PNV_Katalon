...
String imgPath = "C:\\Users\\XUOM\\Testing Exercises\\userstory.jpg"
...
// Step 2: Select File Upload link
WebUI.click(findTestObject('Object Repository/FileUpload_Page/lnk_FileUpload'), FailureHandling.CONTINUE_ON_FAILURE)
...
// Step 3: Click on Choose File button and upload a PNG file, then click Upload button
...
// Step 4: Verify the h3 header changes after upload
...
// Check the file name displayed after upload
